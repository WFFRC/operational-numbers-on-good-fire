...
overallGraphic <- ggplot2::ggplot(allLong)  +
  ...
  coord_flip()
ggplot2::ggsave(plot = overallGraphic, filename = here::here(figsDir, 'overall_v2.png'), units = "in", width = 6, height = 2.5, bg = "transparent")
...
combinedPlot2 <- (stateGraphic + ggplot2::labs(title = NULL)) / (yearGraphic + ggplot2::labs(title = NULL))
combinedPlot2
ggplot2::ggsave(combinedPlot2, filename = here::here(figsDir, 'combined_fig2.png'), units = "in", width = 6, height = 8)
...
kableExtra::kable(overallTbl,
  ...
  save_kable_workaround(here::here(figsDir, 'summary_table_v1.png'))
