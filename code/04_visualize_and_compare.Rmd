...
ggplot(yrStatePerc, aes(year, State, fill = RxPercOfLowLow, label = paste0(sprintf("%.1f", RxPercOfLowLow), "%"))) + 
  geom_tile() + geom_text() +
...
ggplot2::ggsave(here::here(figsDir, 'heatmap.png'), units = "in", width = 15)
